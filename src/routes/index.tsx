...
.jt{background:radial-gradient(ellipse 70% 50% at 10% -5%,rgba(219,234,254,.7) 0%,transparent 60%),radial-gradient(ellipse 55% 45% at 90% 105%,rgba(209,250,229,.5) 0%,transparent 60%),#f0f4f8}

/* ── Light nav ── */
nav{background:rgba(255,255,255,0.95)!important;backdrop-filter:blur(20px)!important;border-bottom:1px solid #e2e8f0!important;box-shadow:0 1px 20px rgba(0,0,0,.06)!important}
.bar{background:rgba(255,255,255,0.9)!important;backdrop-filter:blur(12px)!important}

/* ── White panels with shadow ── */
.lessonList,.enroll,.signup,.community,.locked,.table,.stats>div,.card,.feature,.step,.courseGrid aside,.manageCard,.settingsCard{background:#ffffff!important;border:1px solid #e9f0f8!important;box-shadow:0 2px 16px rgba(0,0,0,.06),0 1px 4px rgba(0,0,0,.04)!important}
.lessonList header{background:transparent!important;box-shadow:none!important}

/* ── Offer banner — light ── */
.offerCycleBanner{background:linear-gradient(135deg,#eff6ff,#f0fdf4)!important;border:1px solid rgba(59,130,246,.2)!important;box-shadow:0 4px 20px rgba(59,130,246,.08)!important}
...
.navBtn{transition:transform .18s,box-shadow .18s!important;background:#fff!important;border:1px solid #e2e8f0!important;color:#1a2332!important}
...
.lessonClickable:hover{transform:translateX(5px)!important;background:rgba(239,246,255,.8)!important}

/* ── Stats cards hover ── */
.stats>div{transition:border-color .25s,box-shadow .25s,transform .25s!important}
.stats>div:hover{border-color:rgba(37,99,235,.3)!important;box-shadow:0 8px 24px rgba(37,99,235,.1)!important;transform:translateY(-2px)!important}
