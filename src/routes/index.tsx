...
function Home(){
  ...
  return (
    <div className="jt">
      ...
      <section className="aboutSection" style={{width:"min(1160px,92%)",margin:"0 auto 80px",display:"grid",gridTemplateColumns:"1.1fr .9fr",gap:"70px",alignItems:"center"}}>
        <div>
          <small style={{color:"#4d8fff",fontSize:"9px",letterSpacing:"2.5px",fontWeight:900}}>ABOUT THE FOUNDER</small>
          <h2 style={{fontSize:"clamp(28px,4vw,42px)",letterSpacing:"-1.5px",margin:"12px 0 20px",lineHeight:1.1}}>Jeya Akash</h2>
          <p style={{lineHeight:1.8,fontSize:"15px",marginBottom:"16px"}}>
          ...
          <div style={{borderLeft:"3px solid #d4af37",paddingLeft:"18px"}}>
            <p style={{margin:0,fontSize:"17px",fontWeight:800,lineHeight:1.7}}>
              Learn and earn.<br/>
              <span style={{fontWeight:400,fontSize:"15px",opacity:0.7}}>Don't work for money — let the money work for you.</span>
            </p>
          </div>
        </div>
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"16px"}}>
          {[["3+","Years Trading"],["1","Simple Strategy"],["500+","Students"],["Tamil Nadu","Based"]].map(([num,label])=>(
            <div key={label} style={{padding:"24px 20px",borderRadius:"16px",border:"1px solid rgba(212,175,55,0.2)",background:"rgba(212,175,55,0.05)",textAlign:"center"}}>
              <div style={{fontSize:"28px",fontWeight:900,color:"#d4af37",letterSpacing:"-1px",marginBottom:"6px"}}>{num}</div>
              <div style={{fontSize:"11px",opacity:0.6,letterSpacing:"0.5px"}}>{label}</div>
            </div>
          ))}
        </div>
      </section>
