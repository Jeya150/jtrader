...
.primary,.heroPrimary{background:linear-gradient(135deg,#fff 0%,#dce9f8 100%)!important;box-shadow:0 4px 18px rgba(255,255,255,.14),0 2px 6px rgba(0,0,0,.35)!important;transition:transform .2s cubic-bezier(.16,1,.3,1),box-shadow .2s!important}
