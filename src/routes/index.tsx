...
body{background:#d1fae5}
.jt{background:radial-gradient(ellipse 70% 50% at 10% -5%,rgba(167,243,208,.5) 0%,transparent 60%),radial-gradient(ellipse 55% 45% at 90% 105%,rgba(110,231,183,.35) 0%,transparent 60%),#d1fae5}

/* ── Light nav ── */
nav{background:rgba(209,250,229,.96)!important;backdrop-filter:blur(20px)!important;border-bottom:1px solid #a7f3d0!important;box-shadow:0 1px 20px rgba(0,0,0,.06)!important}
.bar{background:rgba(209,250,229,.95)!important;backdrop-filter:blur(12px)!important}

/* ── White panels with shadow ── */
.lessonList,.enroll,.signup,.community,.locked,.table,.stats>div,.card,.feature,.step,.courseGrid aside,.manageCard,.settingsCard{background:#ecfdf5!important;border:1px solid #e9f0f8!important;box-shadow:0 2px 16px rgba(0,0,0,.06),0 1px 4px rgba(0,0,0,.04)!important}
.lessonList header{background:transparent!important;box-shadow:none!important}

/* ── Offer banner — light ── */
.offerCycleBanner{background:linear-gradient(135deg,#d1fae5,#ecfdf5)!important;border:1px solid rgba(16,185,129,.25)!important;box-shadow:0 4px 20px rgba(59,130,246,.08)!important}
...
.navBtn{transition:transform .18s,box-shadow .18s!important;background:#ecfdf5!important;border:1px solid #a7f3d0!important;color:#1a2332!important}
...
.lessonClickable:hover{transform:translateX(5px)!important;background:rgba(167,243,208,.5)!important}

/* ── Stats cards hover ── */
.stats>div{transition:border-color .25s,box-shadow .25s,transform .25s!important}
.stats>div:hover{border-color:rgba(16,185,129,.35)!important;box-shadow:0 8px 24px rgba(16,185,129,.12)!important;transform:translateY(-2px)!important}
