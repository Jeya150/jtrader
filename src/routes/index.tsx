    ...
    <div className="jt">
      ...
      <section className="aboutSection" style={{width:"min(1160px,92%)",margin:"0 auto 80px",display:"grid",gridTemplateColumns:"1fr 1fr",gap:"60px",alignItems:"center"}}>
        <div>
          ...
          <p style={{color:"#7c2d12",lineHeight:1.8,fontSize:"15px",marginBottom:"16px"}}>
          ...
          <p style={{color:"#7c2d12",lineHeight:1.8,fontSize:"15px",marginBottom:"24px"}}>
          ...
          <div style={{borderLeft:"3px solid #2563eb",paddingLeft:"18px"}}>
            <p style={{margin:0,fontSize:"17px",fontWeight:800,color:"#7c2d12",lineHeight:1.7}}>
              Learn and earn.<br/>
              <span style={{color:"#c2410c",fontWeight:500,fontSize:"15px"}}>Don't work for money — let the money work for you.</span>
            </p>
          </div>
        </div>
...
body{background:#ffedd5}
.jt{background:radial-gradient(ellipse 70% 50% at 10% -5%,rgba(254,215,170,.5) 0%,transparent 60%),radial-gradient(ellipse 55% 45% at 90% 105%,rgba(253,186,116,.35) 0%,transparent 60%),#ffedd5}

/* ── Light nav ── */
nav{background:rgba(255,237,213,.96)!important;backdrop-filter:blur(20px)!important;border-bottom:1px solid #fed7aa!important;box-shadow:0 1px 20px rgba(0,0,0,.06)!important}
.bar{background:rgba(255,237,213,.95)!important;backdrop-filter:blur(12px)!important}

/* ── White panels with shadow ── */
.lessonList,.enroll,.signup,.community,.locked,.table,.stats>div,.card,.feature,.step,.courseGrid aside,.manageCard,.settingsCard{background:#fff7ed!important;border:1px solid #e9f0f8!important;box-shadow:0 2px 16px rgba(0,0,0,.06),0 1px 4px rgba(0,0,0,.04)!important}
.lessonList header{background:transparent!important;box-shadow:none!important}

/* ── Offer banner — light ── */
.offerCycleBanner{background:linear-gradient(135deg,#ffedd5,#fff7ed)!important;border:1px solid rgba(234,88,12,.25)!important;box-shadow:0 4px 20px rgba(59,130,246,.08)!important}
...
.navBtn{transition:transform .18s,box-shadow .18s!important;background:#fff7ed!important;border:1px solid #fed7aa!important;color:#1a2332!important}
...
.lessonClickable:hover{transform:translateX(5px)!important;background:rgba(254,215,170,.5)!important}

/* ── Stats cards hover ── */
.stats>div{transition:border-color .25s,box-shadow .25s,transform .25s!important}
.stats>div:hover{border-color:rgba(234,88,12,.35)!important;box-shadow:0 8px 24px rgba(234,88,12,.12)!important;transform:translateY(-2px)!important}

/* ── Gradient headings — dark ── */
.welcomeDashboard h1,.pageHero h1{background:linear-gradient(120deg,#7c2d12 30%,#3b82f6 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}
...
.videoModalInner{background:#fff7ed!important;border:1px solid #fed7aa!important;box-shadow:0 24px 80px rgba(0,0,0,.15)!important}

/* ── Footer ── */
footer{background:rgba(255,237,213,.95)!important;backdrop-filter:blur(12px)!important;border-top:1px solid #fed7aa!important;color:#7c2d12!important}
footer b{color:#7c2d12!important;font-size:19px}
footer small,footer span{color:#c2410c!important;opacity:1!important}

/* ── Classy price amount ── */
.courseBottom>b{background:linear-gradient(135deg,#7c2d12,#2563eb,#0ea5e9)!important;-webkit-background-clip:text!important;-webkit-text-fill-color:transparent!important;background-clip:text!important;font-size:34px!important;letter-spacing:-1px!important;text-shadow:none!important}
