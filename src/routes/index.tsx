...
const glassCss=`
/* ── Slide-in ── */
@keyframes jtIn{from{opacity:0;transform:translateY(18px)}to{opacity:1;transform:translateY(0)}}
.jt{animation:jtIn .45s cubic-bezier(.16,1,.3,1)}

/* ── Premium midnight background ── */
body{background:#060d1c}
.jt{background:radial-gradient(ellipse 80% 60% at 15% -10%,rgba(30,58,138,.55) 0%,transparent 55%),radial-gradient(ellipse 55% 45% at 88% 110%,rgba(212,175,55,.12) 0%,transparent 55%),#060d1c}

/* ── Dark glass nav ── */
nav{background:rgba(4,9,22,.88)!important;backdrop-filter:blur(32px) saturate(1.6)!important;border-bottom:1px solid rgba(255,255,255,.06)!important;box-shadow:0 4px 30px rgba(0,0,0,.5),0 1px 0 rgba(212,175,55,.15)!important}
.bar{background:rgba(4,9,22,.92)!important;backdrop-filter:blur(20px)!important;border-bottom:1px solid rgba(255,255,255,.05)!important;color:#94a3b8!important}
.bar b{color:#d4af37!important}
.links button{color:#e2e8f0!important;font-size:12px!important}
.links button:hover{color:#f5c842!important}

/* ── Dark glass panels ── */
.lessonList,.enroll,.signup,.community,.locked,.table,.stats>div,.card,.feature,.step,.courseGrid aside,.manageCard,.settingsCard{background:rgba(10,18,42,.8)!important;backdrop-filter:blur(24px)!important;border:1px solid rgba(255,255,255,.08)!important;box-shadow:0 8px 40px rgba(0,0,0,.5),inset 0 1px 0 rgba(255,255,255,.04)!important;color:#f0f4fc!important}
.lessonList header{background:transparent!important;box-shadow:none!important;border-bottom:1px solid rgba(255,255,255,.07)!important}

/* ── Offer banner — gold ── */
.offerCycleBanner{background:linear-gradient(135deg,rgba(12,22,50,.95),rgba(18,30,65,.95))!important;border:1px solid rgba(212,175,55,.3)!important;box-shadow:0 8px 40px rgba(0,0,0,.4),0 0 60px rgba(212,175,55,.06)!important}

/* ── Gold primary button ── */
.primary{background:linear-gradient(135deg,#c9a227,#f5c842,#d4af37)!important;color:#060d1c!important;font-weight:900!important;box-shadow:0 4px 20px rgba(212,175,55,.4)!important;transition:transform .2s cubic-bezier(.16,1,.3,1),box-shadow .2s!important;border:0!important}
.primary:hover{transform:translateY(-3px) scale(1.02)!important;box-shadow:0 10px 35px rgba(212,175,55,.55)!important}
.heroPrimary{background:linear-gradient(135deg,#c9a227,#f5c842,#d4af37)!important;color:#060d1c!important;font-weight:900!important;box-shadow:0 4px 20px rgba(212,175,55,.4)!important;transition:transform .2s cubic-bezier(.16,1,.3,1),box-shadow .2s!important}
.heroPrimary:hover{transform:translateY(-3px) scale(1.02)!important;box-shadow:0 10px 35px rgba(212,175,55,.55)!important}
.navBtn{background:rgba(212,175,55,.1)!important;border:1px solid rgba(212,175,55,.28)!important;color:#f5c842!important;transition:all .18s!important}
.navBtn:hover{background:rgba(212,175,55,.2)!important;transform:translateY(-2px)!important;box-shadow:0 4px 16px rgba(212,175,55,.2)!important}
.outline{border:1px solid rgba(255,255,255,.15)!important;color:#f0f4fc!important;background:transparent!important}
.outline:hover{border-color:rgba(212,175,55,.4)!important;transform:translateY(-2px)!important}

/* ── Course cards — premium dark ── */
.courseNew{background:rgba(10,18,42,.85)!important;border:1px solid rgba(255,255,255,.08)!important;transition:transform .35s cubic-bezier(.16,1,.3,1),box-shadow .35s!important}
.courseNew:hover{transform:translateY(-10px) scale(1.015)!important}
.basicCourse{border-color:rgba(77,143,255,.35)!important;box-shadow:0 8px 32px rgba(0,0,0,.4),0 0 0 1px rgba(77,143,255,.12)!important}
.basicCourse:hover{box-shadow:0 28px 70px rgba(0,0,0,.65),0 0 70px rgba(77,143,255,.2)!important}
.optionCourse{border-color:rgba(212,175,55,.4)!important;box-shadow:0 8px 32px rgba(0,0,0,.4),0 0 0 1px rgba(212,175,55,.12)!important}
.optionCourse:hover{box-shadow:0 28px 70px rgba(0,0,0,.65),0 0 70px rgba(212,175,55,.22)!important}
.courseBody h3{color:#f0f4fc!important}
.courseBody p{color:#94a3b8!important}
.courseBottom button{background:rgba(255,255,255,.08)!important;color:#f0f4fc!important;border:1px solid rgba(255,255,255,.12)!important}
.courseBottom button:hover{background:rgba(212,175,55,.18)!important;border-color:rgba(212,175,55,.35)!important;transform:translateY(-2px)!important}

/* ── Lesson row hover ── */
.lessonClickable{transition:transform .18s cubic-bezier(.16,1,.3,1),background .18s!important}
.lessonClickable:hover{transform:translateX(5px)!important;background:rgba(77,143,255,.07)!important}

/* ── Stats hover — gold ── */
.stats>div{transition:border-color .25s,box-shadow .25s,transform .25s!important}
.stats>div:hover{border-color:rgba(212,175,55,.28)!important;box-shadow:0 12px 32px rgba(0,0,0,.45),0 0 40px rgba(212,175,55,.08)!important;transform:translateY(-3px)!important}

/* ── Gradient headings ── */
.welcomeDashboard h1,.pageHero h1{background:linear-gradient(120deg,#f0f4fc 30%,#d4af37 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}
.hero h1{background:linear-gradient(110deg,#ffffff 20%,#d4af37 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}

/* ── Input glow ── */
input:focus,textarea:focus,select:focus{border-color:rgba(212,175,55,.5)!important;box-shadow:0 0 0 3px rgba(212,175,55,.1)!important;outline:none!important}

/* ── Video modal ── */
.videoModal{backdrop-filter:blur(10px)!important;background:rgba(0,0,0,.75)!important}
.videoModalInner{background:rgba(10,18,42,.96)!important;border:1px solid rgba(255,255,255,.1)!important;box-shadow:0 40px 100px rgba(0,0,0,.8)!important}
.videoModalHeader h3{color:#f0f4fc!important}
.videoModalClose{color:#64748b!important}
.videoModalClose:hover{background:rgba(255,255,255,.08)!important;color:#f0f4fc!important}

/* ── Footer ── */
footer{background:rgba(4,9,22,.92)!important;backdrop-filter:blur(20px)!important;border-top:1px solid rgba(212,175,55,.18)!important;color:#64748b!important}
footer b{color:#f0f4fc!important}
footer small,footer span{color:#475569!important;opacity:1!important}

/* ── 3-D headings ── */
h1,h2,h3{text-shadow:1px 1px 0 rgba(0,0,0,.5),2px 2px 0 rgba(0,0,0,.35),3px 3px 6px rgba(0,0,0,.4)!important}
.brand span,.logo,.logo b{text-shadow:none!important;color:#f0f4fc!important}
